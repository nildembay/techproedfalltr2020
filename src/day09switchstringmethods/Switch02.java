...
public class Switch02 {
	...
	public static void main(String[] args) {
		/*
		 kullanýcýdan ay ismini giriniz. prograö kacýncý ay oldugunu versin
		 */
		
		Scanner scan=new Scanner(System.in);
		System.out.println("ay ismini giriniz");
		String ay=scan.next().toLowerCase();// kullanýcý büyük harf bile girse hepsini küçük harfe çevirir.
		switch (ay) {
			...
			case "mayýs":	System.out.println("5");	break;
			...
			case "kasým":	System.out.println("11");	break;
			case "aralýk":	System.out.println("12");	break;
